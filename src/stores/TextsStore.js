...
const TextsStore = {
  ...
  data: {
    ...
    bibliograph: [
      ...
      "<li>Amy E. Hillier, &ldquo;Who Received Loans? Home Owners' Loan Corporation Lending and Discrimination in Philadelphiain the 1930s,&rdquo; <cite>Journal of Planning History</cite> 29 (Summer 2005): 3-24.</li>",
