...
export default class ADCat extends React.Component {
  ...
  componentDidMount () {
    this.render19370826_5c = this.render19370203_5c;
    this.render19370203_5d = this.render19370203_5c;
    this.render19370826_5d = this.render19370203_5c;
    this.render19370826_5g = this.render19370203_5g;
    this.render19370826_8a = this.render19370203_8a;
    this.render19370203_8b = this.render19370203_8a;
    this.render19370826_8b = this.render19370203_8a;
    this.render19370203_8c = this.render19370203_8a;
    this.render19370826_8c = this.render19370203_8a;
  }
  ...
  */
  ...
  render () {
    ...
    return (
      <div className='ADCategory sidebar'  style={this.props.style}>
        ...
        { (false && this.props.previousCatIds) ?
          <div 
            className='adNav' 
...
ADCat.propTypes = {
  catNum: PropTypes.number,
  catLetter: PropTypes.string
};
